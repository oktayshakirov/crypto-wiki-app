...
export default function OgsScreen() {
  ...
  // Deep link from a "New OG" push notification: see hooks/useNotificationDeepLink.
  useEffect(() => {
    if (pendingNavigation?.targetTab !== "ogs") {
      return;
    }
  ...
  useEffect(() => {
    if (webViewRef.current) {
      registerWebView("crypto-ogs", webViewRef);
    }
    return () => unregisterWebView("crypto-ogs");
    ...
    <View style={[styles.container, { backgroundColor: Colors.background }]}>
      {Platform.OS === "web" ? (
        <iframe
          ...
          title="TheCrypto.wiki - Crypto OGS"
